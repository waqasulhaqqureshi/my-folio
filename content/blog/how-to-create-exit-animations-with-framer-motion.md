...
subtitle: "Exit Animations with Framer Motion"
date: "2024-05-10"
dateLabel: "MAY 2024"
readingTime: "10 min read"
cover: "https://cdn.hashnode.com/res/hashnode/image/upload/v1715345723909/c71d9691-fe4c-4302-b1cb-d9dca77a99b5.png"
canonical: "https://blog.victorwilliams.me/how-to-create-exit-animations-with-framer-motion"
tags: ["reactjs", "framer-motion", "animation", "typescript", "frontend-development"]
excerpt: "Learn to implement exit animations using the exit prop and AnimatePresence, then build a pop-up modal with everything covered."
---
...
> 💡 For this guide, we'll use a React-TypeScript project and Tailwind CSS for styling. While these are my preferred choices, you can tailor the setup to your existing project or preferences. To follow along with the guide, you can clone the demo's [source code](https://github.com/victorcodess/exit-animation-modal) as well.
...
![A green circle rendered by the basic component](https://cdn.hashnode.com/res/hashnode/image/upload/v1715292325360/f551c6e6-3d6b-4bc5-8cdf-68197ff1d08f.png)
...
![The element fading out smoothly before unmounting](https://cdn.hashnode.com/res/hashnode/image/upload/v1715293939791/1c72de9a-a8c5-4d3e-8c73-1dcacc5b0a99.gif)

**Without `AnimatePresence`:**

![The element disappearing instantly with no animation](https://cdn.hashnode.com/res/hashnode/image/upload/v1715202267718/0a85075f-95d2-4567-a70c-9f7a5b47739b.gif)
...
![The element easing in and out as it fades](https://cdn.hashnode.com/res/hashnode/image/upload/v1715294238910/15c363df-fdf1-4a82-b229-7005fef2cd00.gif)
...
![The element sliding off-screen while rotating](https://cdn.hashnode.com/res/hashnode/image/upload/v1715263506883/2e56cafe-4914-4acf-9b3a-2c9988635ea0.gif)
...
![Parent and child elements exiting in a cascading sequence](https://cdn.hashnode.com/res/hashnode/image/upload/v1715275016571/66873ed3-a148-4c79-abce-d63978e263a8.gif)
...
![The finished modal scaling up on open and shrinking away on close](https://cdn.hashnode.com/res/hashnode/image/upload/v1715268217741/8a0aa218-8b23-4545-a5a1-5376aaef4192.gif)
